# determine the top 5 most popular start stations for casuals
# and the percentage of casual rides that started there
SELECT 
station_name, 
nr_of_rides
FROM
# first table lists the IDs of top 5 most popular start stations for casual riders
# and the percentage of rides that started at those stations
(SELECT 
start_station_id, 
...
ON rentals_table.start_station_id = stations_table.station_id